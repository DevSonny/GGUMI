...
<div style="text-align: center;">
	...
	<h2>${sessionScope.memberVo.id }님환영합니다. 공인중개사로 회원유형이 변경되셨습니다.<br>부동산 매물 등록서비스를 이용하실 수 있습니다.</h2>
	<a href="${contextPath}/member/upEstate.do">부동산매물등록하러가기</a>&emsp;&emsp;&emsp;
