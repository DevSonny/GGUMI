...
<body>
	...
	<div class="container">
		<div class="row">
		<form action="${contextPath}/admin/updatenotice.do?notice_no=${notice.notice_no }" method="POST" enctype="multipart/form-data" >
			<table class="table table-striped" style="text-align: center; border:1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="title" maxlength="50" value="${notice.title }"></td>
					</tr>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 작성자" name="writer" maxlength="50" value="${notice.content }"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder="글 내용" name="content" maxlength="2048" style="height: 350px;">${notice.writer }</textarea></td>
					</tr>
					<tr>
