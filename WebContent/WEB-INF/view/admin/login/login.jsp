...
<body>
	...
	<div class="wrapper">
		<h1>관리자 로그인페이지</h1>
		<form action="${contextPath}/admin/loginCheck.do" method="post">
			아이디(id) :			<input type="text" name="admin_id"><br> 
			비밀번호(pw) :			<input type="password" name="admin_pw"><br>
	
			<input type="submit" value="로그인"> 
			<button type="button" onclick="location.href='admin/join.do'">관리자 회원가입</button>
